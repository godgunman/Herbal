...
public class DataHelper {
	...
	static {
		...
		resIdToHerbals.put(R.drawable.result_jie, Arrays.asList(R.drawable.herb_shell,
				R.drawable.herb_gochi, R.drawable.herb_white));
		resIdToHerbals.put(R.drawable.result_nee, Arrays.asList(R.drawable.herb_flower,
				R.drawable.herb_dog, R.drawable.herb_jinin,
				R.drawable.herb_fish));
		resIdToHerbals.put(R.drawable.result_ya, Arrays.asList(R.drawable.herb_shell,
				R.drawable.herb_lu, R.drawable.herb_jinin, R.drawable.herb_shy));
		resIdToHerbals.put(R.drawable.result_yen, Arrays.asList(R.drawable.herb_lu,
