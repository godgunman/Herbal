...
public class MainActivity extends Activity implements Scanner.SyncListener {
	...
	private static final String API_KEY = "dx7p7r1wbvelvhzhrap2";
	private static final String API_SECRET = "flsb5HFSbjjZbgLp";
	...
	public void onSyncComplete() {
		try {
			Log.d("Moodstocks SDK",
					String.format("Sync succeeded (%d image(s))",
							scanner.count()));
		} catch (MoodstocksError e) {
			e.printStackTrace();
		}
	...
	public void onSyncProgress(int total, int current) {
		...
		Log.d("Moodstocks SDK",
				String.format("Sync progressing: %d%%", percent));
	}
